package app.presentation.segmentedbutton
...
object SegmentedButtonDefaults {
    ...
    fun segmentedButtonPadding(): PaddingValues = PaddingValues(2.dp)

    fun segmentedButtonCorners(cornerValueInPercentage: Int = CORNER_DEFAULT): SegmentedButtonCorners =
        SegmentedButtonCorners(cornerValueInPercentage)
...
class SegmentedButtonCorners {
    ...
    internal constructor(
        topStartPercentage: Int,
        topEndPercentage: Int,
        bottomStartPercentage: Int,
        bottomEndPercentage: Int
    ) {
